...
$ echo "console.log('Hello ' + process.env.HELLO)" > app.js

$ dotenvx run --env-file=.env.production -- node app.js
Hello production
> ^^
```
...
$ dotenvx run --env-file=.env.local --env-file=.env -- node app.js
Hello local
```
...
$ DOTENV_KEY='<dotenv_key_production>' dotenvx run -- node app.js
